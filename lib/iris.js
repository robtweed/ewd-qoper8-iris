/*
 ...
 ----------------------------------------------------------------------------
 | ewd-qoper8-iris: Integrates InterSystems IRIS Data Platform with         |
...
module.exports = function(worker, params) {
  ...
  // establish the connection to IRIS database
  ...
  worker.db = new iface.IRIS();

  params = params || {};
  if (!params.path) params.path = '/opt/iris/mgr';
